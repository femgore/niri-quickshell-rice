...
Item {
    ...
    Scaler {
        ...
        currentWidth: typeof masterWindow !== "undefined"
        ? masterWindow.width
        : Screen.width

        currentHeight: typeof masterWindow !== "undefined"
        ? masterWindow.height
        : Screen.height
    }
    ...
    onTargetMasterWidthChanged: {
        if (typeof masterWindow !== "undefined") {
            ...
            let availableWidth = masterWindow.screen
            ? masterWindow.screen.width
            : Screen.width;
            let newX = Math.floor((availableWidth - window.targetMasterWidth) / 2);
