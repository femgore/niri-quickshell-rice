...
Variants {
    ...
    delegate: Component {
	    ...
	    Process {
            ...
            Process {
                id: settingsWatcher
                command: ["bash", "-c", "while [ ! -f ~/.config/quickshell/settings.json ]; do sleep 1; done; inotifywait -qq -e modify,close_write ~/.config/quickshell/settings.json"]
                running: true
                stdout: StdioCollector {
                    onStreamFinished: {
            ...
            Process {
                id: wsDaemon
                command: ["bash", "-c", "~/.config/niri/imperative/scripts/workspaces.sh"]
                running: true
            }
                        ...
                        Row {
                            ...
                            Row {
                                ...
                                Item { 
                                    ...
                                    MouseArea { id: prevMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached([Quickshell.env("HOME") + "/.config/quickshell/music/player_control.sh", "prev", "", "", barWindow.musicData.playerName || ""]); musicForceRefresh.running = true; } } 
                                }
                                Item { 
                                    ...
                                    MouseArea { id: playMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached([Quickshell.env("HOME") + "/.config/quickshell/music/player_control.sh", "play-pause", "", "", barWindow.musicData.playerName || ""]); musicForceRefresh.running = true; } } 
                                }
                                Item { 
                                    width: barWindow.s(24); height: barWindow.s(24); 
                                    anchors.verticalCenter: parent.verticalCenter
                                    ...
                                    MouseArea { id: nextMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached([Quickshell.env("HOME") + "/.config/quickshell/music/player_control.sh", "next", "", "", barWindow.musicData.playerName || ""]); musicForceRefresh.running = true; } } 
                                }
                            }
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: kbMouse; anchors.fill: parent; hoverEnabled: true; onClicked: Quickshell.execDetached(["notify-send", "Keyboard layout", "Use Niri input settings to configure layout switching."]) }
                            }
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer {
                                    running: rightContent.showLayout && !parent.initAnimTrigger
                                    interval: 25
                                    onTriggered: parent.initAnimTrigger = true
                                }
                                opacity: initAnimTrigger ? 1 : 0
                                transform: Translate {
                                    y: parent.initAnimTrigger ? 0 : barWindow.s(15)
                                    Behavior on y {
                                        NumberAnimation {
                                            duration: 500
                                            easing.type: Easing.OutBack
                                ...
                                Text {
                                    anchors.centerIn: parent
                                    text: barWindow.isRecording ? "" : ""
                                    font.family: "Iosevka Nerd Font"
                                    font.pixelSize: barWindow.isRecording
                                        ? barWindow.s(18)
                                        : barWindow.s(13)
                                        color: barWindow.isRecording
                                        ? mocha.crust
                                        : (recButton.isHovered ? mocha.text : mocha.overlay2)
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        Quickshell.execDetached([
                                            "bash",
                                            "-c",
                                            "~/.config/niri/scripts/screenshot.sh --full --record"
                                        ])
                                    }
                                }
                            }
