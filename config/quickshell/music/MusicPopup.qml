                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            MouseArea {
                                ...
                                onClicked: root.execCmd(`$HOME/.config/quickshell/music/player_control.sh prev '' '' "${root.musicData.playerName || ""}"`)
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    root.musicData = temp;
                                    root.execCmd(`$HOME/.config/quickshell/music/player_control.sh play-pause '' '' "${root.musicData.playerName || ""}"`);
                                }
                            ...
                            MouseArea {
                                width: root.s(30); height: root.s(30)
                                cursorShape: Qt.PointingHandCursor
                                onClicked: root.execCmd(`$HOME/.config/quickshell/music/player_control.sh next '' '' "${root.musicData.playerName || ""}"`)
                                Text { anchors.centerIn: parent; text: ""; color: parent.pressed ? root.text : root.overlay2; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(24) }
                            }
                        }
                    }
